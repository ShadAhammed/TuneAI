"""Naive Bayes (Gaussian) wrapper with automated hyperparameter tuning."""

import warnings
warnings.filterwarnings('ignore')

from src.models.ModelTuning import Tuner
from models.ModelParams import NBParams, NBModel


class NaiveBayes:
    """Tune and fit a Gaussian Naive Bayes classifier.
    ...
    def TunedModel(self):
        tuner = Tuner(NBParams, NBModel, self.X_train, self.y_train)

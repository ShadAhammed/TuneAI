"""K-Nearest Neighbours wrapper with automated hyperparameter tuning."""

import warnings
warnings.filterwarnings('ignore')

from src.models.ModelTuning import Tuner
from models.ModelParams import KNNParams, KNNModel


class KNearestNeighbour:
    """Tune and fit a KNN classifier.
    ...
    def TunedModel(self):
        tuner = Tuner(KNNParams, KNNModel, self.X_train, self.y_train)

"""XGBoost wrapper with automated hyperparameter tuning."""

import warnings
warnings.filterwarnings('ignore')

from src.models.ModelTuning import Tuner
from models.ModelParams import XGBParams, XGBModel


class XtremeGrad:
    """Tune and fit an XGBoost classifier.
    ...
    def TunedModel(self):
        tuner = Tuner(XGBParams, XGBModel, self.X_train, self.y_train)

"""Support Vector Machine wrapper with automated hyperparameter tuning."""

import warnings
warnings.filterwarnings('ignore')

from src.models.ModelTuning import Tuner
from models.ModelParams import SVCParams, SVCModel


class SupportVector:
    """Tune and fit an SVC with an RBF kernel.
    ...
    def TunedModel(self):
        tuner = Tuner(SVCParams, SVCModel, self.X_train, self.y_train)
